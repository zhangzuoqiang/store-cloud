...
import com.graby.store.portal.inventory.InventoryService.AccountEntry;
import com.graby.store.portal.inventory.InventoryService.AccountEntrys;
import com.graby.store.portal.service.ShipOrderService;
...
public class AdminEntryController {
	...
	public String entryOperateForm(@PathVariable("id") Long id, Model model) throws ApiException {
		...
		System.out.println(order.getDetails().iterator().next().getItem().getId());

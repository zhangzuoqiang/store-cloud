...
<body>
	...
	<tr>
		<td colspan="5"><a href="${ctx}/admin/trade/check/${order.id}" class="btn btn-primary">打印拣货单</a></td>
	</tr>
	</tbody>
	</table>	
	...
	<div class="form-actions">
		<a href="${ctx}/admin/trade/check/${order.id}" class="btn btn-primary">确认发货</a>
		<a href="${ctx}/admin/trade/send/waits" class="btn">暂不处理</a>
	</div>

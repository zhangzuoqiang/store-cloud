...
<head>
	...
	<script>
		...
		$(document).on("focus", ".send_num", function(e) {
			$(this).css("background-color","#FFFFCC");
			var btnid = $(this)[0].id;
			$("."+btnid).show();
	    });
	    
		$(document).on("blur", ".send_num", function(e) {
		...
		<c:forEach items="${items}" var="item">
			<tr>
				...
				<td>
				    ...
				    <a class="btn hide ${item.id}_num" href="javascript:addItem(${item.id},'${item.id}_num');">添加</a>
				</td>
			</tr>
		</c:forEach>
		</tbody>
